...
class Footer extends HTMLElement {
    connectedCallback() {
        ...
        <footer class="bg-[#24292b] h-[870px] md:h-[370px] mt-[200px]">
            ...
            >
                <img
                src="/Yunex-Clone/assets/images/icons/facebook-icon.svg"
                alt="facebook-icon"
                class="size-[40px] "
                />
                <img
                src="/Yunex-Clone/assets/images/icons/twitter_icon.svg"
                alt="twittter-icon"
                class="size-[40px]"
                />
                <img
                src="/Yunex-Clone/assets/images/icons/youtube_icon.svg"
                alt="youtube-icon"
                class="size-[40px]"
                />
                <img
                src="/Yunex-Clone/assets/images/icons/instagram_icon.svg"
                alt="instagram-icon"
                class="size-[40px] "
                />
            </div>
