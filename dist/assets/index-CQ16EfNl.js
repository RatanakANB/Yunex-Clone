(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=class extends HTMLElement{connectedCallback(){this.innerHTML=`
            ...
            `}};customElements.define(`card-component`,e);var t=[`badminton`,`tennis`,`golf`,`running`,`snowboard`,`about`];function n(e){let t=document.querySelector(`#`+e);t&&(t.style.maxHeight=t.style.maxHeight===`500px`?`0px`:`500px`)}function r(e){n(t[e-1]),document.getElementById(`overlay-blur`).classList.toggle(`hidden`)}function i(e){n(t[Math.abs(e)-1]),document.getElementById(`overlay-blur`).classList.toggle(`hidden`)}function a(){let e=document.querySelector(`#golf`);e&&(e.style.maxHeight=`500px`),document.getElementById(`overlay-blur`).classList.remove(`hidden`)}function o(){let e=document.querySelector(`#golf`);e&&(e.style.maxHeight=`0px`),document.getElementById(`overlay-blur`).classList.add(`hidden`)}function s(){let e=document.getElementById(`mySidenav`);e.style.width=`80%`,e.style.overflowY=`auto`,document.getElementById(`overlay-blur1`).classList.remove(`hidden`),document.querySelector(`body`).classList.add(`overflow-y-hidden`),document.querySelector(`#hamburger-logo`).classList.add(`hidden`),document.querySelector(`#close-sidebar`).classList.remove(`hidden`)}function c(){let e=document.getElementById(`mySidenav`);e.style.width=`0px`,e.style.overflowY=`hidden`,document.getElementById(`overlay-blur1`).classList.add(`hidden`),document.querySelector(`body`).classList.remove(`overflow-y-hidden`),document.querySelector(`#hamburger-logo`).classList.remove(`hidden`),document.querySelector(`#close-sidebar`).classList.add(`hidden`)}var l=[`badminton-drop`,`golf-drop`,`tennis-drop`,`running-drop`,`snowboard-drop`,`about-drop`];function u(e){let t=document.getElementById(l[e-1]);t&&(t.style.maxHeight=t.style.maxHeight===`300px`?`0px`:`300px`)}var d=0;function f(e){let t=document.querySelector(` .slideShow1`),n=t.querySelectorAll(`.slide-list1`),r=n[0].clientWidth;d=Math.max(0,Math.min(d+e,n.length-1)),t.scrollTo({left:d*r,behavior:`smooth`})}var p=0;m();function m(){let e,t=document.getElementsByClassName(`recent-slide`),n=document.getElementsByClassName(`dot-recent`);for(e=0;e<t.length;e++)t[e].style.display=`none`;p++,p>t.length&&(p=1),t[p-1].style.display=`flex`,n[p-1].className+=` active`,setTimeout(m,3e3)}function h(){document.getElementById(`search-bar`).classList.toggle(`hidden`),document.getElementById(`search-bar`).classList.toggle(`flex`)}function g(){document.getElementById(`search-bar`).classList.toggle(`hidden`),document.getElementById(`search-bar`).classList.toggle(`flex`)}function _(){document.getElementById(`search-bar2`).classList.toggle(`hidden`),document.getElementById(`search-bar2`).classList.toggle(`flex`)}function v(){document.getElementById(`search-bar2`).classList.toggle(`hidden`),document.getElementById(`search-bar2`).classList.toggle(`flex`)}window.hoverDrop=r,window.hoverHide=i,window.golfDrop=a,window.golfHide=o,window.openNav=s,window.closeNav=c,window.showDropdown=u,window.pushArrow1=f,window.opensearch=h,window.closesearch=g,window.opensearchresponse=_,window.closesearchresponse=v;var y=class extends HTMLElement{connectedCallback(){this.innerHTML=`
        ...
        `}};customElements.define(`my-footer`,y);var b=class extends HTMLElement{connectedCallback(){let e=this.getAttribute(`bg-color`);this.innerHTML=`
    ...
    `,A=class extends HTMLElement{constructor(){super(),this.cards=w[0].imgBanner,this.slideIndex=1}connectedCallback(){let e=E[this.getAttribute(`data-source`)]||[];this.innerHTML=D(e),this.showSlides(this.slideIndex),this.querySelector(`.prev`).addEventListener(`click`,()=>this.plusSlides(-1)),this.querySelector(`.next`).addEventListener(`click`,()=>this.plusSlides(1))}plusSlides(e){this.showSlides(this.slideIndex+=e)}showSlides(e){let t=this.getElementsByClassName(`mySlides`);e>t.length&&(this.slideIndex=1),e<1&&(this.slideIndex=t.length);for(let e=0;e<t.length;e++)t[e].style.display=`none`;t[this.slideIndex-1].style.display=`block`}};customElements.define(`hero-slider`,A);var j=class extends HTMLElement{constructor(){super(),this.items=T[0].imgResponsive,this.slideIndex=1}connectedCallback(){let e=E[this.getAttribute(`card-data-source`)]||[];this.innerHTML=O(e),this.showSlides1()}showSlides1(){let e,t=document.getElementsByClassName(`mySlides1`),n=document.getElementsByClassName(`dot`);for(e=0;e<t.length;e++)t[e].style.display=`none`;this.slideIndex++,this.slideIndex>t.length&&(this.slideIndex=1),t[this.slideIndex-1].style.display=`block`,n[this.slideIndex-1].className+=` active`,setTimeout(this.showSlides1.bind(this),2e3)}};customElements.define(`hero-responsive`,j);var M=class extends HTMLElement{constructor(){super(),this.currentSlide=0}connectedCallback(){let e=E[this.getAttribute(`card-slide`)]||[],t=this.getAttribute(`text-style`);this.innerHTML=k(e,t),this.querySelector(`.back`).addEventListener(`click`,()=>this.plusSlides(1)),this.querySelector(`.skip`).addEventListener(`click`,()=>this.plusSlides(-1))}plusSlides(e){let t=this.querySelector(`.slideShow`),n=t.querySelectorAll(`.slide-list`),r=n[0].clientWidth;this.currentSlide=Math.max(0,Math.min(this.currentSlide+e,n.length-1)),t.scrollTo({left:this.currentSlide*r,behavior:`smooth`})}};customElements.define(`card-carousel`,M);var N=class extends HTMLElement{connectedCallback(){this.innerHTML=`
      ...
      >
        ...
        `}};customElements.define(`my-sidebar`,N);